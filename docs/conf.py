...
llms_txt_description = textwrap.dedent(
    """\
    This is the documentation for gopkg-charmed, a Kubernetes charm that deploys and operates the gopkg.in versioned import-path service with a 12-factor workflow.
    """
)
